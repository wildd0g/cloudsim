 ...
 */
public class PowerVmAllocationPolicyMigrationStaticThresholdV2 extends PowerVmAllocationPolicyMigrationAbstract {
	 ...
	 */
	public PowerVmAllocationPolicyMigrationStaticThresholdV2(
	...
	public PowerHost findHostForVm(Vm vm, Set<? extends Host> excludedHosts) {
		...
		for (PowerHost host : this.<PowerHost> getHostList()) {
			...
			if (host.isSuitableForVm(vm)) {
				...
				if (allocatedHost == null && getUtilizationOfCpuMips(host) == 0) {allocatedHost = host; continue;}
